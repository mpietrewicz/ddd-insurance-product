...
public class OfferStartController { // todo: zamienić na OfferSchedulingController ?

    private final OfferSchedulingUseCase offerSchedulingUseCase;
    ...
    public RepresentationModel<?> canChangeStartDate(@PathVariable OfferId offerId) {
        ...
        List<LocalDate> availableStartDates = offerSchedulingUseCase.getAvailableStartDates(offerId);
    ...
    public ResponseEntity<RepresentationModel<?>> changeStartDate(@PathVariable OfferId offerId,
        ...
        offerSchedulingUseCase.changeStartDate(offerId, startDate);

package pl.mpietrewicz.insurance.product.repository.config;
...
@EnableJpaRepositories(
        basePackages = {
                "pl.mpietrewicz.insurance.product.repository",
                "pl.mpietrewicz.insurance.product.readmodel.repository"
        },
...
public class InfrastructureConfig {
    ...
    public LocalContainerEntityManagerFactoryBean productEntityManagerFactory(
        ...
        return builder
                ...
                .packages("pl.mpietrewicz.insurance.product.domain")
